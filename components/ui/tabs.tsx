...
>(({ className, ...props }, ref) => (
  <div className="px-0 sm:px-34 lg:px-60">
    <TabsPrimitive.List
      ref={ref}
      className={cn(
        "inline-flex max-lg:w-full h-9 lg:gap-5 items-center justify-center rounded-lg bg-slate-100 p-1 text-slate-500 dark:bg-slate-800 dark:text-slate-400",
        className
      )}
      {...props}
    />
